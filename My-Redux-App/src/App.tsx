...
export default function App() {
  ...
  return (
    <>
      <div
        className={`min-h-screen transition-all duration-500 ${isDark ? "bg-gray-900 text-white" : "bg-linear-to-br from-gray-50 to-gray-100"}`}
      >
        {/* Navbar */}
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className={`ml-4 px-4 py-1.5 rounded-lg text-sm font-bold transition-all shadow-md ${isDark ? "bg-yellow-400 text-gray-900" : "bg-gray-800 text-white"}`}
                >
                  {isDark ? "☀️ Light" : "🌙 Dark"}
                </button>
              </div>
          ...
          <div className="text-center">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 text-lg">
                Simple counter application with Redux state management
              </p>
            </div>

            {/* Counter Card */}
            <div
              className={`max-w-md mx-auto rounded-2xl shadow-xl overflow-hidden mb-8 transition-colors ${isDark ? "bg-gray-800 border border-gray-700" : "bg-white"}`}
            >
              ...
              <div className="px-6 py-8">
                <div
                  className={`text-7xl md:text-8xl font-bold mb-4 ${isDark ? "text-white" : "text-gray-800"}`}
                >
                  {counter}
                </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              ...
              <p className="text-xs text-gray-400 mt-3">
                Quick increment/decrement actions
              </p>
            </div>
          </div>
        </div>
